...
define gui.text_font = "big_noodle_titling.ttf"

## The font used for character names.
define gui.name_text_font = "big_noodle_titling.ttf"

## The font used for out-of-game text.
define gui.interface_text_font = "big_noodle_titling.ttf"
...
define gui.text_outlines = [ (1, "#000000ff", 0, 0)]

## The size and colour of the name text outline
define gui.name_text_outlines = [ (1, "#000000ff", 0, 0)]

## The size and colour of the interface text outline
define gui.interface_text_outlines = [ (1, "#000000ff", 0, 0)]

## The size and colour of the label text outline
define gui.labeltext_outlines = [ (1, "#000000ff", 0, 0)]

## The size and colour of the notify text outline
define gui.notify_outlines = [ (1, "#000000ff", 0, 0)]

## The size and colour of the title text outline
define gui.title_text_outlines = [ (1, "#000000ff", 0, 0)]


## Main and Game Menus #########################################################

## The images used for the main and game menus.
define gui.main_menu_background = "gui/city.png"
define gui.game_menu_background = "gui/city.png"
