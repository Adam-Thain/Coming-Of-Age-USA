...
image intro:
    ...
    "white"
    0.5
    "Backgrounds/splash.png" with Dissolve(0.5, alpha=True)
    2.5
...
image tos = "Backgrounds/warning.png"
image tos2 = "Backgrounds/warning2.png"
...
label splashscreen:
    ...
    # if s_kill_early:
    #     show black
    #     play music "BackgroundMusic/s_kill_early.ogg"
    #     $ pause(1.0)
    #     show end with dissolve_cg
    #     $ pause(3.0)
    #     scene white
